           ...
           <tr>
              <td className="px-5 py-5 text-sm bg-white border-b border-gray-200">
                <div className="flex items-center">
                  <div className="ml-3">
                    <p className=" text-textColor whitespace-no-wrap">2024/05/13</p>
                  </div>
                </div>
              </td>
              <td className="px-5 py-5 text-sm bg-white border-b border-gray-200">
                <p className=" text-textColor whitespace-no-wrap">GeoJson</p>
              </td>
              <td
              ...
              <td className="px-5 py-5 text-sm bg-white border-b border-gray-200">
                ...
                >
                  ...
                  <span className="relative"> Visualizar </span>
                </span>
              </td>
              <td className="px-5 py-5 text-sm bg-white border-b border-gray-200">
                <span
                  className="relative inline-block px-3 py-1 font-semibold leading-tight text-textColor"
                >
                  <span
                    aria-hidden="true"
                  ...
                  <span className="relative underline"> Descargar </span>
                </span>
              </td>
            </tr>
